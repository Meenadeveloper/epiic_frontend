...
function PlacementOfficeMobile({isPhoneVerified,setIsPhoneVerified,additionalData= {},setPhoneInParent,name}) {

    const [phoneNumber, setPhoneNumber] = useState(additionalData.phone || '');
...
<div className="register-row">
      <div className="register-col">
        <div className={`register-form-control ${errorMessage ? 'error-input' : ''}`}>
          <label className="register-label">Placement Officer Mobile No. </label>
          <PhoneInput
            international
            defaultCountry="IN"
            name={name}
...
export default PlacementOfficeMobile

...
function CandidateSpecialization({
    name,
    formData,
    formErrors,
    handleChange,
     ...
     // States for selected option, input value, and API data
         const [selectedOption, setSelectedOption] = useState(
           formData.specialization ? { label: formData.specialization, value: formData.specializationId } : null
         );
         ...
         const handleSelectChange = (option) => {
           ...
           handleChange({
             target: { name: 'specializationId', value: option.value }, // Set college ID
           });
         };

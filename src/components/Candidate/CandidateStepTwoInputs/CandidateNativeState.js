          ...
          <label className='register-label'>Select State</label>
                <div className="dropdown-container trasparent-dropdown-box" ref={dropdownRef}>
                   ...
                   <input
                      ...
                      <i className="material-icons dropdown-icon" onClick={toggleDropdown}>arrow_drop_down</i>
                    </div>
                  {/* Display error message if exists */}
               {formErrors.stateId && <p className="error selectbox-error">{formErrors.stateId}</p>}
              ...
              <ul className="dropdown-container">
                ...
                filteredStates.map((state) => (
                  state.state_name === 'No states found' ? (
                    <li key="no-states-found" className="b-txt">
                      No states found
                    </li>
                  ) : (
                    <li
                ...
                <li className="b-txt">No states found</li>
              )}
              </ul>
            </div>
             )}
...
export default CandidateNativeState
...
function ClassificationOfIndustry({ formData, formErrors, handleChange }) {
    // States for selected option, input value, and API data
        const [selectedOption, setSelectedOption] = useState(
          formData.turnover
            ? { label: formData.classifiedindustry, value: formData.classifiedindustryId }
            : null
        );
        ...
        const handleCreateOption = (inputValue) => {
         ...
         handleChange({
          target: { name: 'classifiedindustry', value: newOption.label },
        });
...
export default ClassificationOfIndustry
